...
def eval_fragment_dice_hd(sem_gt: Path, dt_path: Path, echo: bool = True) -> Dict[str, Any]:
    ...
    with redirect_stdout(buf):
        dice, hd = evalSemantic(coco_sem, str(dt_path), return_hd=True)
...
def main():
    ...
    payload: Dict[str, Any] = {
        "meta": {
            ...
            "note": "Retained paper metrics: blastomere instance AP/F1/Precision/Recall plus fragment Dice/HD.",
        }
    }
    ...
    if args.sem_gt:
        payload["fragment_semantic_final"] = eval_fragment_dice_hd(
